...
1. **知识图谱数据模型**：实体定义、关系定义、属性规范文档（本文件）。
 2. **主干图谱实例**：覆盖肥料→食品链条的 Neo4j 数据库实例 (61 边, 28 节点)，包含：
   - 化肥公司及化肥产品节点
...
**总计：28 节点，61 边 (24 [:提供] + 22 [:用于] + 15 [:供应给])**
...
| Mosaic | Potash, DAP |
| ADM | Corn Starch, HFCS, Soybean Meal, Soybean Oil, Wheat Flour, Ethanol, Animal Feed |
